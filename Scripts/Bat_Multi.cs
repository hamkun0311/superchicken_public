...
public class Bat_Multi : MonoBehaviour
{
    Animator anim;
    ...
    public float tmp_moveSpeed = 0.15f;
    ...
    void Start()
    {
        ...
        slash.Stop();
        touch.Stop(); 
        dmg_atk = dmg_atk + (dmg_atk * GM1.gameLevel / 10);
    }
    ...
    void callEnemy()
    {
        PhotonNetwork.Instantiate("Bat_Enemy", GM1.getCirclePosition(), Quaternion.identity);
    }

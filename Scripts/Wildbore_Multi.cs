...
public class Wildbore_Multi : MonoBehaviour
{
    ...
    public float tmp_moveSpeed = 0.35f;
    ...
    private IEnumerator DeadGoblinCo()
    {
        ...
        GM.goldCnt = GM.goldCnt + 30;
        GM.wildboreChk = false;
        GM.goldCnt++;
        GM.m_killCnt++;
        ...
        int rand_unit = randomObj.Next(1,1000); // 1~8까지 난수발생
    ...
    void callEnemy()
    {
        PhotonNetwork.Instantiate("Wildbore_Enemy", GM.getCirclePosition(), Quaternion.identity);
    }
}

...
public class Hellhound_Multi : MonoBehaviour
{
    ...
    public float tmp_moveSpeed = 0.5f;
    ...
    private IEnumerator DeadGoblinCo()
    {
        ...
        GM.goldCnt = GM.goldCnt + 50;
        GM.hellhoundChk = false;
        GM.m_killCnt++;
    ...
    void callEnemy()
    {
        PhotonNetwork.Instantiate("Hellhound_Enemy", GM.getCirclePosition(), Quaternion.identity);
    }
}

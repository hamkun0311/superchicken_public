...
public class Redbird_Multi : MonoBehaviour
{
    Animator anim;
    ...
    public float tmp_moveSpeed = 0.25f;
    ...
    void callEnemy()
    {
        PhotonNetwork.Instantiate("Redbird_Enemy", GM.getCirclePosition(), Quaternion.identity);
    }
}

...
public class Yellowbird_Multi : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        slash.Stop();
        touch.Stop(); 
        dmg_atk = dmg_atk + (dmg_atk * GM.gameLevel / 10);
    }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            if(other.transform.parent.name == "guard_multi(Clone)")
            {
    ...
    void callEnemy()
    {
        PhotonNetwork.Instantiate("Yellowbird_Enemy", GM.getCirclePosition(), Quaternion.identity);
    }
}

...
public class swordman_multi : MonoBehaviour
{
...
public void MoveUnit(int enemy_no)
    ...
    public void getUnitInfo()
    {
        ...
        iteminfo.item_id = GM1.select_unit_id;
        iteminfo.item_name = GM1.select_unit_name;
        iteminfo.item_grade = GM1.select_unit_grade;
        iteminfo.item_value = GM1.select_unit_value;
    ...
    private IEnumerator DeadSwordManCo()
    {
        ...
        for(int i = 0; i < 10; i++)
        {
            if(iteminfo.item_id == GM1.setslot[i].item_id)
            {
                GM1.s_unit_cnt[i]--;
            }
        }
